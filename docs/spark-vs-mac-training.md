...
4. **Keep Spark as the GPU publish artifact** ([decisionlens/mistral7b-mdmp-lora](https://huggingface.co/decisionlens/mistral7b-mdmp-lora)). MLX v4 is the **Mac Hub sidecar** ([decisionlens/mistral7b-mdmp-lora-mlx](https://huggingface.co/decisionlens/mistral7b-mdmp-lora-mlx)), not a conversion of the Unsloth adapter. If a paper or demo needs one numbered GPU model, quote Spark v7 unless the Mac stack is named explicitly.
